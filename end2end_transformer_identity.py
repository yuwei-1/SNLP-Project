...
from extractive_models.Identity.IdentityExtractor import getIdentitySummarization
...
def extract_summaries(articles, L=100, extractor=getIdentitySummarization):
    """
...
if __name__ == '__main__':
    ...
    EPOCHS = 1000       # how many times you want to iterate over the entire dataset
    print('\nStarting Training\n')
